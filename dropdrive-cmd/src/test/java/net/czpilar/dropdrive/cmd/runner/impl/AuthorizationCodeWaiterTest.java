...
class AuthorizationCodeWaiterTest {
    ...
    private static final String TEST_CONTEXT = "/dropdrive-test";

    private AuthorizationCodeWaiter createWaiter(int port) {
        DropDriveSetting setting = mock(DropDriveSetting.class);
        ...
        waiter.setDropDriveSetting(setting);
        return waiter;
    }
    ...
    void testGetCodeResponseContainsHtmlContent() throws Exception {
        ...
        assertTrue(response.contains("dropDrive application has been authorized"));
